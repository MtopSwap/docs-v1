...
const config: DocsThemeConfig = {
  head: () => {
    ...
    const url =
      'https://mtop-documentation.vercel.app/' +
    ...
    return <>
      ...
      <meta property="og:description" content={frontMatter.description || 'Welcome to the MtopSwap documentation website, your go-to resource for learning about our MetaDEX platform. Our platform is built on 10 EVM chains, including Ethereum, Arbitrum, Binance Smart Chain, and Polygon, providing lightning-fast trades at a fraction of the cost of traditional exchanges. With our advanced routing technology and integration with more than 10 aggregators, we are able to offer the best prices in the market. Our documentation includes comprehensive guides, tutorials, and FAQs to help you make the most of our simplified and intuitive user interface. Whether you are a new user or an experienced one, we are here to help you navigate our MetaDEX and revolutionize the way you trade crypto-assets.'} />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:image" content="/socialcard.png" />
      <meta name="twitter:site:domain" content="docs.mtopswap.com" />
      <meta name="twitter:url" content="https://mtop-documentation.vercel.app/" />
  ...
  project: {
    link: 'https://github.com/0xAlexander/mtop-documentation/',
  },
  chat: {
    link: 'https://discord.gg/mtopswap',
  },
  docsRepositoryBase: 'https://github.com/0xAlexander/mtop-documentation/blob/main/',
      ...
      <div className="flex w-full flex-col items-center sm:items-start">
        <div>
          <a
            ...
            title="netra.site about page"
            href="https://nextra.site/about"
          >
      ...
      <div>
        <div style={{display: 'inline-flex'}}>
          <a
            ...
            href="https://nextra.site/about"
          >
            <span style={{display: 'inline-flex'}}>Powered by&nbsp;</span>
            <svg
